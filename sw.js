...
const CACHE_ADI = 'gida-denetim-v3';
...
// Kurulum: kaynakları tek tek önbelleğe al (biri başarısız olursa diğerleri etkilenmiyor)
...
// Fetch: Firebase ve API istekleri network'e, geri kalanı cache-first
self.addEventListener('fetch', function(e) {
  var url = e.request.url;

  // Firebase / API - her zaman network
